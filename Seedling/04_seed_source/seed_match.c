...
void elem_value(int t, char *expected)           { if (Token.token_rep == t) { if (output_flag) {  light_cyan();     printf(" %s\n", expected);  reset(); } } }
void mark_value(int t, char *expected)           { if (Token.token_rep == t) { if (output_flag) {  light_cyan();     printf(" %s\n", expected);  reset(); } } }

void load_elem(int t, char *expected)           { if (Token.token_rep == t) { if (output_flag) {  light_cyan();     printf(" %s\n", expected);  reset(); } } }
...
void dec_den(int t, char *expected)            { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
void dec_bay(int t, char *expected)            { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
void dec_aisle(int t, char *expected)          { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
void dec_zone(int t, char *expected)           { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }

void dec_dens(int t, char *expected)            { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
void dec_bays(int t, char *expected)            { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
void dec_aisles(int t, char *expected)          { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
void dec_zones(int t, char *expected)           { if (Token.token_rep == t) { if (output_flag) {  light_gray();  printf(" %s\n", expected);  reset(); } } }
...
void log_sect(int t, char *expected)      { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }
void list_sect(int t, char *expected)      { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }

void log_label(int t, char *expected)      { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }
void list_label(int t, char *expected)      { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }

void log_offset(int t, char *expected)    { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }
void list_index(int t, char *expected)    { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }

void end_log(int t, char *expected)    { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }
void end_list(int t, char *expected)    { if (Token.token_rep == t) { if (output_flag) {  dark_cyan();      printf(" %s\n", expected);  reset(); } } }
