...
void dec_den(int t, char *expected);
void dec_bay(int t, char *expected);
void dec_aisle(int t, char *expected);
void dec_zone(int t, char *expected);
void dec_dens(int t, char *expected);
void dec_bays(int t, char *expected);
void dec_aisles(int t, char *expected);
void dec_zones(int t, char *expected);
...
void log_sect(int t, char *expected);     
void list_sect(int t, char *expected);

void log_label(int t, char *expected);     
void list_label(int t, char *expected);


void log_offset(int t, char *expected);
void list_index(int t, char *expected);
void end_log(int t, char *expected);
void end_list(int t, char *expected);
...
void load_elem(int t, char *expected);
void elem_value(int t, char *expected);
