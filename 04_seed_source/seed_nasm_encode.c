			...
			switch(current_size)
			{
				case 8:
					switch (arith_type)
					{
						...
						case 3:  fprintf(temp_text, "    mul %s,", dest.phrase_num_value); break;
						case 4:  fprintf(temp_text, "    div %s,", dest.phrase_num_value); break;
						default: break;
					}
				break;
				case 16:
			...
			switch(current_size)
			{
				case 8:
					switch (arith_type)
					{
						...
						case 3:  fprintf(temp_text, "    mul %s,", dest.phrase_reg_value); break;
						case 4:  fprintf(temp_text, "    div %s,", dest.phrase_reg_value); break;
						default: break;
					}
				break;
				case 16:
			...
			switch(current_size)
			{
				case 8:
					switch (arith_type)
					{
						...
						case 3:  fprintf(temp_text, " %d\n", src.phrase_num_value); break;
						case 4:  fprintf(temp_text, " %d\n", src.phrase_num_value); break;
						default: break;
					}
				break;
				case 16:
...
void encode_destination_phrase(int byte_size, phrase_retrievel dest)
{
	switch (dest.type)
	{
		...
		case phrase_hex:
		{
			switch (byte_size)
			{
				case 8:  fprintf(temp_text, "0x%02X, n", dest.phrase_hex_value); break;
				case 16: fprintf(temp_text, "0x%04X, n", dest.phrase_hex_value); break;
				case 32: fprintf(temp_text, "0x%08X, ", dest.phrase_hex_value); break;
				case 64: fprintf(temp_text, "0x%016lX, ", dest.phrase_hex_value); break;
				default: break;
			}
		} break;
		default: break;
	...
	switch (src.type)
	{
		...
		case phrase_hex:
		{
			switch (byte_size)
			{
				...
				case 64: fprintf(temp_text, "0x%016lX\n", src.phrase_hex_value); break;
				default: break;
			}
		}break;
		default:break;
